...
//This is the base class that should be copied from when making new weapons
//Controls all weapon related modifiable stats one could think of
    ...
    public void FireWeapon()
    {
        ...
        if (attackReady)
        {
            ...
            for (int i = 0; i < numberOfShots; i++)
            {
                ...
                shootSound.pitch = Random.Range(0.75f, 1.25f);
                shootSound.Play();
            }
            ammoRemaining--;
